...
public class Camera2Activity extends AppCompatActivity {
    ...
    private String mImageOutPath = Utils.getCamera2Output();
    ...
    private ImageReader.OnImageAvailableListener mImageAvailableListener =
            reader -> mBackgroundHandler.post(new ImageSaver(reader.acquireNextImage(), mImageOutPath));
    ...
    private void init() {
        ...
        findViewById(R.id.camera2_btn_take_picture).setOnClickListener(v -> {
            try {
    ...
    private void setUpCameraOutputs(int width, int height) {
        ...
        try {
            for (String cameraId : manager.getCameraIdList()) {
                ...
                mSensorOrientation = characteristics.get(CameraCharacteristics.LENS_FACING);
                boolean swap = false;
        ...
        try {
            ...
            CameraCaptureSession.CaptureCallback callback = new CameraCaptureSession.CaptureCallback() {
                ...
                public void onCaptureCompleted(@NonNull CameraCaptureSession session,
                                               @NonNull CaptureRequest request,
                                               @NonNull TotalCaptureResult result) {
                    ToastHelper.showOnUiThread("Save: " + mImageOutPath);
                    Log.d(TAG, mImageOutPath);
                    unlockFocus();
                }
            };
            ...
            mCaptureSession.capture(builder.build(), callback, null);
        } catch (CameraAccessException e) {
            e.printStackTrace();
        }
    }
    ...
    private static class ImageSaver implements Runnable {
        ...
        private ImageSaver(Image image, String filePath) {
            mImage = image;
            mFilePath = filePath;
        }
